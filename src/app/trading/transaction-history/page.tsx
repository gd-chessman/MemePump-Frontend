...
function TransactionHistoryContent() {
    ...
    <div key={index} className="p-3 border-b border-gray-100 dark:border-neutral-800/50 hover:bg-gray-50 dark:hover:bg-neutral-800/30">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        ...
        <div>
          ...
          <span className="ml-1 text-gray-700 dark:text-neutral-200">COMPLETED</span>
        </div>
      </div>
  ...
  return (
    <div className="box-shadow-info rounded-xl p-2 sm:p-3 lg:overflow-hidden bg-white dark:bg-neutral-1000 flex flex-col h-full w-full">
